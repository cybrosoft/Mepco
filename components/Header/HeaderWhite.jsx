...
export default function HeaderWhite() {
  ...
  return (
    <header className="w-full z-50 bg-white border-b border-gray-200 text-gray-900">
      <div className="max-w-7xl mx-auto px-5">
        <div className="flex items-center justify-between h-[80px] pt-0">
          {/* Logo */}
          <Link href="/" className="flex items-center h-14">
            <Image
              ...
              className="w-auto h-[52px] transition-all duration-300"
              priority
            />
          </Link>
