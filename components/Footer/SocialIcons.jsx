...
export function SocialIcon({ href, label, children }) {
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-black/25 text-black/80 hover:text-black hover:border-black/40 transition"
    >
      {children}
    </Link>
  );
...
export function InstagramIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M17.5 6.7a1.1 1.1 0 11-2.2 0 1.1 1.1 0 012.2 0z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
      <path
        ...
        opacity="0.9"
      />
      <path d="M10 15.5V8.5l6 3.5-6 3.5z" fill="#e2d9c8" />
    </svg>
  );
}
