...
export const PRODUCTS_SEO = {
  ...
  description: "Explore MEPCO's containerboard and paperboard solutions engineered for durability, converting efficiency, moisture resistance, and print excellence.",
  keywords: ["MEPCO","Middle East Paper Company","Products","Containerboard","Paperboard","Linerboard","Fluting","Testliner","Kraft Liner","White Top Liner","Coreboard","Plasterboard Liner","Absorbent Kraft","Corrugated Packaging","Packaging Grades","Saudi Arabia"],
  robots: { index: true, follow: true },
  openGraph: { type: "website", siteName: "MEPCO", locale: "en_US", alternateLocale: ["ar_SA"], imagePath: "/products/og-products.jpg" },
  twitter: { card: "summary_large_image", imagePath: "/products/og-products.jpg" },
};
export const PRODUCTS_HEADER = {
  title: "Products",
  description: "Explore MEPCO's containerboard and paperboard portfolio—engineered for strength, converting efficiency, moisture resistance, and print excellence.",
};
export const PRODUCTS_CTA = {
  title: "Need help choosing the right grade?",
  description: "Share your application (end use, basis weight, moisture exposure, and printing requirements) and we'll recommend the best fit.",
  primaryButton: { label: "Contact sales →", href: "/contact-us" },
  secondaryButton: { label: "Sustainability", href: "/sustainability" },
};
...
export const PRODUCTS = [
  // ===================== CONTAINERBOARD =====================
  {
    ...
    endUses: ["Beverages","Consumer Durables","Detergents","Industrial Goods","Processed Food"],
    basisWeights: "From 112 to 200 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [90, 100, 112, 120, 125, 140, 150, 160, 175, 190, 200],
    properties: [
      "High speed forming and bonding on corrugators",
      "Reliable impact protection (cushioning) and stacking strength",
    ],
    certifications: ["FSC Recycled Certified (FSC-C124131)","ISEGA certified (direct food contact certificate)"],
  ...
  },
  {
    ...
    basisWeights: "From 112 to 200 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [90, 100, 112, 120, 125, 140, 145, 160, 175, 200, 250],
    properties: [
    ...
    certifications: ["FSC Recycled Certified","ISEGA certified (direct food contact certificate)"],
  ...
  },
  {
    ...
    subtitle: "DUAL USE",
    category: "containerboard",
    usage: "Mixture of fluting & testliner (corrugating medium + outer/inner layers)",
    endUses: ["Beverages","Consumer Durables","Detergents","Industrial Goods","Processed Food"],
    basisWeights: "From 90 to 160 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [90, 100, 110, 120, 130, 140, 160],
    properties: [
  ...
  },
  {
    ...
    // ✅ From Sample Book PDF
    basisWeightOptions: [112, 127, 140, 150, 160],
    properties: [
  ...
  },
  {
    ...
    category: "containerboard",
    usage: "Outer and inner layers of a carton box",
    endUses: ["Frozen Food","Fresh Food","Beverages","Consumer Durables","Detergents","Industrial Goods"],
    basisWeights: "From 110 to 200 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [110, 125, 135, 150, 160, 175, 200, 250, 300],
    properties: [
  ...
  },
  {
    ...
    // ✅ From Sample Book PDF
    basisWeightOptions: [125, 140, 150, 160, 175, 200],
    properties: [
  ...
  // ===================== PAPERBOARD =====================
  {
    ...
    subtitle: "COREBOARD",
    category: "paperboard",
    usage: "Multi-ply board wound and laminated with adhesive forming a paper tube or core",
    endUses: ["Film","Tape & Label","Textiles","Paper"],
    basisWeights: "From 200 to 550 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [200, 250, 300, 350, 400, 450, 500, 550],
    properties: [
  ...
  },
  {
    ...
    category: "paperboard",
    usage: "Layers of linerboard bonded to a gypsum plaster core forming a wallboard",
    endUses: ["Interior wall lining systems"],
    basisWeights: "From 160 to 220 g/m²",
    // ✅ From Sample Book PDF — Ivory (170,180,190) + Grey (150,160,170) variants combined
    basisWeightOptions: [150, 160, 170, 180, 190],
    properties: [
  ...
  },
  {
    ...
    category: "paperboard",
    usage: "Base paper for impregnation with phenolic resins in decorative laminates",
    endUses: ["Laminated furniture and shelves","Laminated counters and floors"],
    basisWeights: "From 140 to 160 g/m²",
    // ✅ From Sample Book PDF
    basisWeightOptions: [140, 150, 160],
    properties: [
...
export const HOME_PRODUCT_IDS = [
  "mepflute","mepliner","mepdual","mepchem","mepkraft","mepwhite",
  "mepcore","mepgypsum","meplaminate",
];

export const HOME_PRODUCTS = HOME_PRODUCT_IDS.map((id) => {
  const p = PRODUCTS.find((x) => x.id === id);
  if (!p) return null;
  return { id: p.id, name: p.name, desc: `${p.subtitle}, for ${p.usage}`, image: p.image, href: `/products#${p.id}` };
}).filter(Boolean);
